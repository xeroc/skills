...
description: the unique style used by chainsquad
---

### ChainSquad Design Principles

- **Grid first.** 12-column grid, 8px base unit.
- **Mobile first, always.** Default classes target mobile. `sm:`, `md:`, `lg:` layer in structure.
- **Whitespace is structure.** Generous padding is the design.
- **Opacity, not hue, creates hierarchy.** `text-stone-900/70` for secondary, `/40` for tertiary.
- **One accent.** Each project uses exactly one accent color at multiple opacities.
...
### Stone Palette (Light → Dark)

| Role            | Light          | Dark          |
| --------------- | -------------- | ------------- |
| Page background | `stone-50`     | `stone-950`   |
| Surface / card  | `stone-100`    | `stone-900`   |
| Border          | `stone-200`    | `stone-800`   |
| Primary text    | `stone-900`    | `stone-50`    |
| Secondary text  | `stone-900/70` | `stone-50/70` |
| Tertiary text   | `stone-900/40` | `stone-50/40` |

### When to Read Reference Files

| Task                                                                                                                                                   | File                       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------- |
| UI components: nav, section labels, pull quotes, geometric decorations, cards, badges, progress bars, list items, footers, dark mode toggle            | `references/components.md` |
| Full section layouts: poster, data table, app chrome, form, color palette, responsive, hero (Swiss), editorial (Swiss), masonry grid, category filters | `references/sections.md`   |
