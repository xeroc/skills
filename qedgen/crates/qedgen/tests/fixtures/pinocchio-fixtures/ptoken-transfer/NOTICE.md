...
This fixture is **synthesized** Rust source matching the patterns documented in
`references/probes/pinocchio/`. It is NOT a
...
If a future patch vendors upstream source verbatim, this file will be updated
with the upstream commit hash and full attribution.
